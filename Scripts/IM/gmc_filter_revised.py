...
low_mag = 4
high_mag = 4.5
basedir = '/Volumes/SeaJade 2 Backup/NZ/mseed_'+str(low_mag)+'-'+str(high_mag)+'/'
newdir = '/Volumes/SeaJade 2 Backup/NZ/mseed_'+str(low_mag)+'-'+str(high_mag)+'_preferred/'

sorter = ['HN','BN','HH','BH','EH','SH']

filename = '/Volumes/SeaJade 2 Backup/NZ/NZ_EQ_Catalog/earthquakes-7.csv'
gmc_results = pd.read_csv('/Volumes/SeaJade 2 Backup/NZ/gmc_record/mseed_'+str(low_mag)+'-'+str(high_mag)+'_results/results.csv',low_memory=False)
